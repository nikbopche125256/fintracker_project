...
class TransactionCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Failed to add transaction. Please correct the errors below.')
...
class GoalCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.error(request, 'Failed to add goal. Please correct the errors below.')
